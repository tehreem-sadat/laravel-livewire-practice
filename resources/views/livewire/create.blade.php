<form class="space-y-6 p-6 bg-white rounded-lg max-w-md mx-auto">
    ...
    <div class="form-group">
        ...
        <input type="password" id="password" wire:model="password" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
        @error('password') <span class="text-red-600 text-sm">{{ $message }}</span> @enderror
    </div>

    <div class="form-group">
        <label for="approved" class="inline-flex items-center">
            <input type="checkbox" class="form-checkbox" id="approved" wire:model="approved">
    ...
    <div class="flex space-x-4">
        ...
        <button type="button" wire:click.prevent="closeModal()" class="px-4 py-2 bg-gray-500 text-white font-semibold rounded-md shadow-sm hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
            Cancel
        </button>
    </div>
</form>
